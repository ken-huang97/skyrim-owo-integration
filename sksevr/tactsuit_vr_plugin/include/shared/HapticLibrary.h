...
// Initializes a connection to the bHaptics Player. Should only be called once: when the game starts.
DLL_PUBLIC void Initialise(const char* appId, const char* appNmae);

// End the connection to the bHaptics Player. Should only be called once: when the game ends.
