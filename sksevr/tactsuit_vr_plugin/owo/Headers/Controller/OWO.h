...
namespace OWOGame {
    ...
    public:
        ...
        void Send(sharedPtr<OWOGame::Sensation> sensation);
        void Stop();
        ...
        template<typename T = Network> static sharedPtr<OWO> Create()
        {
            return CreateNewShared(OWO, OWO(ClientFactory::Create(CreateNew(T))));
        };
    };
}